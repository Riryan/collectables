...
RDX.RegisterServerCallback('rdx_collectables:ready', function(source, cb)
...
RDX.RegisterServerCallback('rdx_collectables:collected', function(source, cb, Collectable, Type, Group)
    local xPlayer = RDX.GetPlayerFromId(source)
    ...
    MySQL.Async.execute('UPDATE user_collectables SET ' .. Group.ID .. ' = @group WHERE identifier = @identifier', {
        ...
        TriggerEvent("rdx_collectables:itemCollected", xPlayer, Collectable, Group)
...
RDX.RegisterServerCallback('rdx_collectables:reset', function(source, cb, group)
    local xPlayer = RDX.GetPlayerFromId(source)
    ...
    MySQL.Async.execute('UPDATE user_collectables SET ' .. group.ID .. ' = @group WHERE identifier = @identifier', {
        ...
        TriggerEvent("rdx_collectables:resetProgress", xPlayer, Collectable, Group, Total)
